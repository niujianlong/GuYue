...
bool RoleCreateLayer::init()
{
    ...
    Label *Label2 = Label::createWithTTF(FontChina::G2U("召唤、辅助、周旋"), "fonts/FZKATJW.ttf", 28);
    ...
    Label *Label3 = Label::createWithTTF(FontChina::G2U("强力、强力、还是强力"), "fonts/FZKATJW.ttf", 28);
